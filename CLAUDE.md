...
**Остаётся пользователю:** создать git-тег → GitHub Actions соберёт релиз; добавить репозиторий в BRAT; ручной e2e на iOS (полный/инкрементальный синк, удаление, offline, неверный пароль).
